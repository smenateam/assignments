...
Авторизация и регистрация в приложении реализована через `jwt-token`
...
Здесь содержится форма авторизации пользователя. Так же должен быть предусмотрен переход на страницу `/register` в виде кнопки

### Описание страницы `/register`

Здесь содержится форма регистрации пользователя. Так же должен быть предусмотрен переход на страницу `/login` в виде кнопки
